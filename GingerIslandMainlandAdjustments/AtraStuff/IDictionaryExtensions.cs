...
public static class IDictionaryExtensions
{
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TValue? GetValueOrGetDefault<TKey, TValue>(this IDictionary<TKey, TValue> dictionary, TKey key)
        where TValue : class => key is not null && dictionary.TryGetValue(key, out TValue? value) ? value : default;
}
