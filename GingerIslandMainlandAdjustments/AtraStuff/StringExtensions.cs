...
public static class StringExtensions
{
    ...
    public static ReadOnlySpan<char> GetNthChunk(this string str, char deliminator, int index = 0)
    {
        if (index < 0 || index > str.Length + 1)
            throw new IndexOutOfRangeException($"GetNthChunk {index}");
    ...
    [Pure]
    [MethodImpl(TKConstants.Hot)]
    public static int GetIndexOfWhiteSpace(this string str) => str.AsSpan().GetIndexOfWhiteSpace();
    ...
    [Pure]
    [MethodImpl(TKConstants.Hot)]
    public static int GetLastIndexOfWhiteSpace(this string str) => str.AsSpan().GetLastIndexOfWhiteSpace();
